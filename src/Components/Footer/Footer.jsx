  ...
  return (
    <footer className="bg-[#8ecae6] dark:bg-gray-900 flex-col py-14 md:py-20 flex items-center justify-center">
      <div className="max-w-3xl mx-auto">
        ...
        <div>
          <p className="font-main dark:text-gray-300 pb-4 border-b mt-4 px-4 md:px-0 border-gray-800 dark:border-gray-600 font-medium text-center md:text-lg">
        ...
        <div className="flex justify-center gap-4">
          <a
            ...
            aria-label="LinkedIn"
          >
            <FaLinkedin className="w-5 h-5 hover:text-main  duration-300 dark:text-gray-300" />
          </a>
          <a
            target="_blank"
            ...
            aria-label="Twitter"
          >
            <FaTwitter className="w-5 h-5 hover:text-main  duration-300 dark:text-gray-300" />
          </a>
          <a
            target="_blank"
            ...
            aria-label="Facebook"
          >
            <FaFacebook className="w-5 h-5 hover:text-main duration-300 dark:text-gray-300" />
          </a>
        </div>
      </div>
    </footer>
