      ...
      <div className="flex items-center pb-3 border-b border-gray-300 justify-between">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div>
            ...
            <p className="font-main text-lg md:text-xl font-medium">
              {time}
            </p>
          </div>
        </div>
          ...
          <div className=" relative" ref={dropdownRef}>
            ...
            <AnimatePresence>
              {dropdownOpen && (
                ...
                >
                  <ul>
                    <li onClick={ReportOpen} className="px-4 py-2 font-main text-center font-medium hover:bg-gray-100 cursor-pointer">
                      Report
                    </li>
                  </ul>
                </motion.div>
